...
const LoginRegister = () => {
    ...
    */
    ...
    return (
        ...
        <div className=" container mx-5 masterbck">
            <div className="row">
                <h1 className="col-11">Ingreso Maestros</h1>
            ...
            <div className="row">
                ...
                <div className="col-6 my-3 ">
                    ...
                    <form onSubmit={registro} className="my-3" >
                ...
                <Link to="/player" className="col-12  btn btn-success my-5">Ser Aprendiz </Link>
            </div>
        </div>
    )
